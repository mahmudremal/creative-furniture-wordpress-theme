...
?>
  ...
  <div class="flex flex-col gap-7 items-start justify-start px-4 w-full max-w-full md:w-[1440px] m-auto relative">
    ...
    <div class="flex flex-col md:flex-row flex-wrap gap-4 items-start justify-start self-stretch shrink-0 relative">
      ...
      <!-- <div class="flex -sm:hidden flex-col items-start justify-center w-full relative">
          ...
          <div class="blaze-container">
            <div class="blaze-track-container">
              <div class="blaze-track">
                <div class="relative overflow-hidden" style="background: url(<?php echo esc_url($theme_directory_uri); ?>/dist/images/v2/frame-16100692210.png) center;background-size: cover;background-repeat: no-repeat;">
                  <?php foreach ($hotspots->top_left as $spot) : ?>
                  <div class="bg-[rgba(255,255,255,0.11)] rounded-[26px] p-2.5 flex flex-row gap-2.5 items-center justify-start absolute hotspot-indicator" 
                      style="backdrop-filter: blur(4px); top: <?php echo $spot['top']; ?>; left: <?php echo $spot['left']; ?>;"
                      data-tippy-content='<div class="bg-[#ffffff] -rounded-lg p-2 flex flex-row gap-2 items-center justify-start relative shadow-lg min-w-[150px]">
                ...
                <div class="relative overflow-hidden" style="background: url(<?php echo esc_url($theme_directory_uri); ?>/dist/images/v2/frame-16100692200.png) center;background-size: cover;background-repeat: no-repeat;">
                  <?php foreach ($hotspots->bottom_left as $spot) : ?>
                  <div class="bg-[rgba(255,255,255,0.11)] rounded-[26px] p-2.5 flex flex-row gap-2.5 items-center justify-start absolute hotspot-indicator" 
                      style="backdrop-filter: blur(4px); top: <?php echo $spot['top']; ?>; left: <?php echo $spot['left']; ?>;"
                      data-tippy-content='<div class="bg-[#ffffff] -rounded-lg p-2 flex flex-row gap-2 items-center justify-start relative shadow-lg min-w-[150px]">
                ...
                <div class="relative overflow-hidden" style="background: url(<?php echo esc_url($theme_directory_uri); ?>/dist/images/v2/frame-16100692251.png) center;background-size: cover;background-repeat: no-repeat;">
                  <?php foreach ($hotspots->top_right as $index => $spot) : ?>
                  <div class="bg-[rgba(255,255,255,0.11)] rounded-[26px] p-2.5 flex flex-row gap-2.5 items-center justify-start absolute hotspot-indicator" 
                      style="backdrop-filter: blur(4px); top: <?php echo esc_attr($spot['top']); ?>; left: <?php echo esc_attr($spot['left']); ?>;"
                      data-tippy-content='<div class="bg-[#ffffff] -rounded-lg p-2 flex flex-row gap-2 items-center justify-start relative shadow-lg min-w-[150px]">
