...
<div class="relative flex flex-col gap-10 px-4 md:px-0">
    ...
    <div class="flex flex-row gap-2 items-center justify-between px-4 w-full max-w-full md:w-[1440px] m-auto relative">
...
if ( woocommerce_product_loop() ) {
    ?>
        <div class="shop-container flex flex-col gap-6 items-start justify-start px-4 w-full max-w-full md:w-[1440px] m-auto relative">
            <div class="w-full">
