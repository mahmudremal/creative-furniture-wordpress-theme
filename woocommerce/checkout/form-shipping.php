...
<div class="woocommerce-shipping-fields">
	<?php if ( true === WC()->cart->needs_shipping_address() ) : ?>
		...
		<div class="shipping_address">
			...
			<div class="rounded-lg border-solid border-[#e9eaf0] border flex flex-col gap-0 items-start justify-start self-stretch shrink-0 relative overflow-hidden mt-6">
                <div class="bg-[#f6f6f6] p-4 flex flex-col gap-3.5 items-start justify-start self-stretch shrink-0 relative">
                    ...
                    $render_field = function($key, $field, $is_half = false, $is_third = false) use ($checkout, $fw_class) {
                        ...
                        $field['input_class'] = array('design-input', 'bg-transparent', 'border-none', 'outline-none', 'w-full', 'font-[\'Raleway-Regular\']', 'text-base', 'text-[#111111]', 'p-0', 'focus:ring-0', 'mt-3', 'appearance-none', $key);
