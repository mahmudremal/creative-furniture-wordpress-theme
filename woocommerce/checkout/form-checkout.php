...
<div class="flex flex-col gap-7 pt-10 pb-20">
    <!-- Breadcrumbs -->
    <div class="flex flex-wrap gap-2 items-center justify-start px-4 w-full max-w-full md:w-[1440px] 2xl:w-[1920px] m-auto relative">
    ...
    <form name="checkout" method="post" class="checkout woocommerce-checkout flex flex-col gap-7 px-4 w-full max-w-full md:w-[1440px] 2xl:w-[1920px] m-auto relative" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
