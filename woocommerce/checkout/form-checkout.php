        ...
        <div class="checkout-main">
            <div class="checkout-left">
                ...
                <div class="checkout-section remember-section">
                    <h2>Remember Me</h2>
                    <label class="radio-option">
                        <input type="radio" name="save_info" value="1" checked>
                        <span class="radio-custom"></span>
            ...
            <div class="checkout-right">
                <div class="order-summary">
                    ...
                    <div class="coupon-section">
                        <input type="text" name="coupon_code" class="input-text" id="coupon_code" placeholder="Discount Code" value="">
                        <button type="button" class="button coupon-button" name="apply_coupon" value="<?php esc_attr_e('Apply coupon', 'woocommerce'); ?>">Apply</button>
                    </div>
