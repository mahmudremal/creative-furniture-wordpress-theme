...
<a href="#" class="flex relative">
  <div class="flex flex-col gap-4 items-start justify-start flex-1">
    <div class="self-stretch shrink-0 h-[294px] relative overflow-hidden">
      <img class="absolute right-[-0.4px] left-0 bottom-0 top-0" src="<?php echo esc_url(get_template_directory_uri() . '/dist/images/v2/products/bg-gray.png'); ?>" style="
        background: linear-gradient(to left, #f4f4f4, #f4f4f4);
        object-fit: cover;
      ">
      <img class="w-[257.73px] h-[257.73px] absolute left-[50%] top-[50%]" style="translate: -50% -50%; object-fit: cover; aspect-ratio: 1" src="<?php echo esc_url(get_template_directory_uri() . '/dist/images/v2/products/product-'.$product_id.'.png'); ?>">
