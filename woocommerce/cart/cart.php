...
<div class="flex flex-col gap-7 pt-10 pb-20">
    ...
    <div class="flex flex-wrap md:grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-7 items-start justify-between px-4 w-full max-w-full md:w-[1440px] m-auto relative">
