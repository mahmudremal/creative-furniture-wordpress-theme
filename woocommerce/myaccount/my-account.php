...
<div class="h-[381px] overflow-hidden w-full md:w-[1440px] m-auto relative">
    <div class="absolute right-0 left-0 bottom-0 top-0 overflow-hidden">
        <img class="h-[607px] absolute right-0 left-0 top-[calc(50%_-_404.5px)]" src="<?php echo esc_url(get_template_directory_uri()); ?>/src/img/v2/rectangle-453201.png" style="background: linear-gradient( to left, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2) );object-fit: cover;">
