...
?>
<div class="h-[381px] overflow-hidden w-full max-w-full md:w-[1440px] 2xl:w-[1920px] m-auto relative">
...
<div class="flex flex-col gap-8 md:gap-14 w-full max-w-full md:w-[1440px] 2xl:w-[1920px] m-auto relative">
    <?php
